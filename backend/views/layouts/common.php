...
<div class="wrapper">
                ...
                <?php echo MainSidebarMenu::widget([
                    ...
                    'items' => [
                        ...
                        [
                            ...
                            'url' => ['/documents'],
                            'icon' => FAS::icon('file-archive', ['class' => ['nav-icon']]),
                            'active' => Yii::$app->controller->id === 'documents',
                        ],
                        [
                            'label' => Yii::t('backend', 'Type of documents'),
                            'url' => ['/typeofdocuments'],
                            'icon' => FAS::icon('file-alt', ['class' => ['nav-icon']]),
                            'active' => Yii::$app->controller->id === 'typeofdocuments',
                        ],
                        /*
                        [
    ...
    <footer class="main-footer <?php echo $keyStorage->get('adminlte.footer-small-text') ? 'text-sm' : null ?>">
        <strong>&copy; PDRRMO-ADN <?php echo date('Y') ?></strong>
